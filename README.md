...
**I think this will help solve this pain:** Github's Guide on [Start Writing on Github](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax#GitHub-flavored-markdown)
 ...
 - [ ] Leetcode contest 295 - Q3. Steps to make array non decreasing
       ...
       - [ ]  [Solition1: CodingMohan Youtube channel -for understanding the problem and developing  intution to solve] (https://www.youtube.com/watch?v=XirZ8GtWxWA)
...
- [ ]  Bought another Udemy course on 'Google Cloud Associate Engineer certification preparation' (earlier bought: Redis course .. to finish today)
